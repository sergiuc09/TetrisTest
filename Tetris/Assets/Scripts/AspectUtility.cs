...
public class AspectUtility : MonoBehaviour
{
	...
	{
		float previousAspectRatio = currentAspectRatio;
		...
		// If the aspect ratio hasn't changed, don't do anything.
